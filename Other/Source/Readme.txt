DEVELOPER: Replace the three occurrences of WoxPortable in this file
...
user in an INI file next to WoxPortable.exe called WoxPortable.ini.
...
copy AppNamePortable.ini from this directory to WoxPortable.ini next to
WoxPortable.exe. The options in the INI file are as follows:
